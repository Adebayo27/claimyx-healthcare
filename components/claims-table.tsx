      ...
      <CardContent className="p-2 md:p-6">
        <div className="flex flex-col space-y-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuCheckboxItem
                  ...
                  onCheckedChange={(checked: boolean) =>
                    setStatusFilters((prev) => ({ ...prev, Denied: checked }))
                  }
                >
                  Denied
                </DropdownMenuCheckboxItem>
          ...
          <div className="overflow-x-auto rounded-md border">
            <div className="w-[70vw] md:w-[100vw] min-w-full inline-block align-middle">
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      >
                        <div className="flex items-center">
                          Provider {getSortIcon("insurance_provider")}
                        </div>
                      </TableHead>
                      <TableHead
                        className="cursor-pointer"
                    ...
                    {currentItems.length === 0 ? (
                      ...
                      currentItems.map((claim) => (
                        <TableRow key={claim.patient_id + claim.billing_code}>
                          ...
                          <TableCell>
                            {getStatusBadge(claim.payment_status)}
                          </TableCell>
                          <TableCell>
